...
- **เบื้องหลัง:** ใช้ตาราง `VIEW_MIN` กำหนด "อันดับสิทธิ์ขั้นต่ำ" ของแต่ละเมนู แล้วซ่อนเมนูที่เกินสิทธิ์ออก (กลุ่มเมนูที่ว่างเปล่าจะยุบหายไปด้วย) · กำหนดรายคนทับค่า default ของบทบาทได้ผ่านตัวแก้สิทธิ์ และระดับพนักงานโทรยังถูกจำกัดให้เห็นเฉพาะแถวที่เป็นงานของตัวเอง (caller ตรงกับชื่อตัวเอง) ไม่ใช่แค่ซ่อนเมนู แต่กรองข้อมูลด้วย
